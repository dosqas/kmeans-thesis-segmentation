 ...
 *
 * @return cv::Vec<float, 5> A 5D feature vector with scaled color and spatial components.
 */
[[nodiscard]] cv::Vec<float, 5> makeFeature(const cv::Vec3f& bgr, float x01, float y01);
